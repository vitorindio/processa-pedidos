 ...
 */
export function getEnumValuesWithCustomValues(enumValues?: string | undefined): Array<string>;
export function fieldToReference(entity: any, field: any, pathPrefix?: any[]): {
    id: any;
    entity: any;
    field: any;
    multiple: boolean;
