 ...
 * @param commonjs
 */
export declare function updateLanguagesInDayjsConfigurationTask(this: BaseGenerator, { application, control }: UpdateClientLanguagesTaskParam, { configurationFile, commonjs }: {
