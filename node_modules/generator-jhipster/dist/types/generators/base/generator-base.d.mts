...
import { Logger } from './support/index.mjs';
import type { JHipsterGeneratorOptions, JHipsterGeneratorFeatures, EditFileCallback, EditFileOptions, CascatedEditFileCallback, JHipsterOptions, ValidationResult, WriteFileOptions, JHipsterArguments } from './api.mjs';
...
export default class CoreGenerator extends YeomanGenerator {
    ...
    getArgsForPriority(priorityName: string): {
        control: import("./types.mjs").Control;
        source: any;
    }[] | {
        control: import("./types.mjs").Control;
    }[];
