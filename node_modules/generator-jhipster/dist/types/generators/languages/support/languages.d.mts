...
export declare const supportedLanguages: ReadonlyArray<Language>;
export declare const findLanguageForTag: (languageTag: string, languages?: ReadonlyArray<Language>) => Language | undefined;
export declare const defaultLanguage: Required<Language>;
/**
 * Generate language objects in array of "'en': { name: 'English' }" format
 * @param languages
 */
export declare const generateLanguagesWebappOptions: (languages: ReadonlyArray<Language>) => string[];
export declare function languagesAsChoices(languages?: ReadonlyArray<Language>): {
    value: string;
    name: string;
}[];
export {};
