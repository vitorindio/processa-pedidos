...
export declare const MESSAGE_BROKER = "messageBroker";
export declare const MESSAGE_BROKER_KAFKA = "kafka";
export declare const MESSAGE_BROKER_PULSAR = "pulsar";
export declare const MESSAGE_BROKER_NO = "no";
declare const optionDefinition: JHipsterOptionDefinition;
