...
const { BASE_NAME, PACKAGE_NAME, PACKAGE_FOLDER, DATABASE_TYPE, MESSAGE_BROKER, CACHE_PROVIDER, APPLICATION_TYPE, AUTHENTICATION_TYPE, REACTIVE, } = OptionNames;
        ...
        return {
            writing() {
                ...
                this.controllerActions.forEach(action => {
                    ...
                    this.log.log(chalk.green(`adding ${action.actionMethod} action '${action.actionName}' for /api/${this.apiPrefix}/${action.actionPath}`));
                });
                this.writeFile(`${this.fetchFromInstalledJHipster('spring-controller/templates')}/${SERVER_MAIN_SRC_DIR}package/web/rest/Resource.java.ejs`, `${SERVER_MAIN_SRC_DIR}${this.packageFolder}/web/rest/${this.controllerClass}.java`);
                this.writeFile(`${this.fetchFromInstalledJHipster('spring-controller/templates')}/${SERVER_TEST_SRC_DIR}package/web/rest/ResourceIT.java.ejs`, `${SERVER_TEST_SRC_DIR}${this.packageFolder}/web/rest/${this.controllerClass}IT.java`);
            },
        };
    }
