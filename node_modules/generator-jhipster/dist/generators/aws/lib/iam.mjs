...
const hasRole = roleName => getRole(roleName)
    .then(() => true)
    .catch(err => {
...
const createInstanceProfileWithAttachment = () => createInstanceProfile(INSTANCE_PROFILE_ROLE).then(() => addRoleToInstanceProfile(INSTANCE_PROFILE_ROLE, INSTANCE_PROFILE_ROLE));
