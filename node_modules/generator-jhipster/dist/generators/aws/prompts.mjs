    ...
    const prompts = [
        ...
        },
        {
            ...
            validate: input => {
                ...
                if (input.length < 8)
                    return 'Password must contain minimum 8 chars';
                return true;
            },
        },
        {
        ...
        },
        {
            ...
            validate: input => {
                if (input === '')
                    return 'Please provide a valid EC2 instance type';
                return true;
            },
        },
        {
        ...
        },
        {
            ...
            message: 'Enter the RDS instance class (Refer: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html)?',
            validate: input => {
                if (input === '')
                    return 'Please provide a valid RDS instance class';
                return true;
            },
        },
        {
