...
import { prepareField as prepareFieldForLiquibase, postPrepareEntity, relationshipEquals, relationshipNeedsForeignKeyRecreationOnly, prepareRelationshipForLiquibase, } from './support/index.mjs';
import { addEntitiesOtherRelationships, prepareEntity as prepareEntityForServer } from '../server/support/index.mjs';
import { loadEntitiesOtherSide, prepareEntityPrimaryKeyForTemplates, prepareRelationship, prepareField, prepareEntity, loadRequiredConfigIntoEntity, loadEntitiesAnnotations, } from '../base-application/support/index.mjs';
...
export default class LiquibaseGenerator extends BaseApplicationGenerator {
    ...
    /* ======================================================================== */
    _composeWithIncrementalChangelogProvider(entities, databaseChangelog) {
     ...
     */
    _generateChangelogFromFiles(application) {
        const oldEntitiesConfig = Object.fromEntries(this.getExistingEntityNames()
        ...
        return this.getExistingEntityNames().map(entityName => {
            ...
            if (this.recreateInitialChangelog ||
                !application.incrementalChangelog ||
                !oldEntitiesConfig[entityName] ||
                !fs.existsSync(this.destinationPath(`src/main/resources/config/liquibase/changelog/${newConfig.changelogDate}_added_entity_${entityName}.xml`))) {
                return [
                    {
                        ...BASE_CHANGELOG,
            ...
            const oldConfig = oldEntitiesConfig[entityName];
