...
import { applicationTypes, authenticationTypes, databaseTypes, monitoringTypes, searchEngineTypes, serviceDiscoveryTypes, ingressTypes, } from '../../jdl/jhipster/index.mjs';
