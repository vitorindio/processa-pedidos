...
const command = {
    ...
    options: {
        interactive: {
            description: 'Generate multiple applications in series so that questions can be interacted with. This is the default when there is an existing application configuration in any of the folders',
            type: Boolean,
            scope: 'generator',
        },
        jsonOnly: {
