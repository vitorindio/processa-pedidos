            ...
            templates: [
                {
                    ...
                    renameTo: generator => `${generator.packageFolder}web/filter/OAuth2${generator.reactive ? 'Reactive' : ''}RefreshTokensWebFilter.java`,
                },
            ],
        },
        {
...
export const baseServerFiles = {
    ...
    serverJavaDomain: [
        {
            condition: generator => generator.databaseTypeSql || generator.databaseTypeMongodb || generator.databaseTypeNeo4j || generator.databaseTypeCouchbase,
            path: `${SERVER_MAIN_SRC_DIR}package/`,
            renameTo: moveToJavaPackageSrcDir,
