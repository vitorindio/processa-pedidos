...
import { applicationOptions, applicationTypes, authenticationTypes, buildToolTypes, databaseTypes, cacheTypes, serviceDiscoveryTypes, } from '../../jdl/jhipster/index.mjs';
