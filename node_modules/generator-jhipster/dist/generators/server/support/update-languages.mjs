 ...
 * @param application
 */
export function updateLanguagesInMailServiceITTask({ application, control }) {
    ...
    this.editFile(`${javaPackageTestDir}/service/MailServiceIT.java`, { ignoreNonExisting }, content => content.replace(/private.*static.*String.*languages.*\{([^}]*jhipster-needle-i18n-language-constant[^}]*)\};/g, newContent));
}
