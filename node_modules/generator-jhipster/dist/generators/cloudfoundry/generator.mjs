...
export default class CloudfoundryGenerator extends BaseGenerator {
    ...
    get default() {
        return {
            cloudfoundryAppShow: runAsync(function () {
                if (this.abort || typeof this.dist_repo_url !== 'undefined')
                    return;
                const done = this.async();
            ...
            cloudfoundryAppCreate: runAsync(function () {
                ...
                if (this.databaseType !== 'no') {
                    ...
                    const child = exec(`cf create-service ${this.cloudfoundryDatabaseServiceName} ${this.cloudfoundryDatabaseServicePlan} ${this.cloudfoundryDeployedName}`, {}, (err, stdout, stderr) => {
                        done();
                    });
    ...
    get end() {
        return {
            ...
            restartApp() {
                if (this.abort || !this.cloudfoundry_remote_exists)
                    return;
