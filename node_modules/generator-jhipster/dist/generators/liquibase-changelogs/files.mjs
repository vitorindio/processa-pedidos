            ...
            templates: [
                {
                    ...
                    renameTo: generator => `config/liquibase/changelog/${generator.changelogDate}_added_entity_constraints_${generator.entity.entityClass}.xml`,
                },
            ],
        },
    ],
            ...
            templates: [
                {
                    ...
                    renameTo: generator => `config/liquibase/changelog/${generator.databaseChangelog.changelogDate}_updated_entity_${generator.entity.entityClass}.xml`,
                },
            ],
        },
    ],
            ...
            templates: [
                {
                    ...
                    renameTo: generator => `config/liquibase/changelog/${generator.databaseChangelog.changelogDate}_updated_entity_constraints_${generator.entity.entityClass}.xml`,
                },
            ],
        },
    ],
            ...
            templates: [
                {
                    ...
                    renameTo: generator => `config/liquibase/changelog/${generator.databaseChangelog.changelogDate}_updated_entity_migrate_${generator.entity.entityClass}.xml`,
                },
            ],
        },
    ],
