                    ...
                    case MarkupReadStateEnum.startOrEndTag:
                        ...
                        if (match[1]) {
                            ...
                            const namespaceURI = tagName === 'SVG'
                                ? NamespaceURI.svg
                                : currentNode.namespaceURI || NamespaceURI.html;
                            ...
                            match[4] ||
                            (match[6] && currentNode.namespaceURI === NamespaceURI.html)) {
                            // Comment.
                            let comment;
                            if (match[3]) {
                                comment = match[3];
                    ...
                    case MarkupReadStateEnum.insideStartTag:
                        ...
                        if (match[7] || match[8]) {
                            ...
                            if (hasAttributeStringEnded) {
                                ...
                                if (VoidElements[currentNode.tagName] ||
                                    (match[7] && currentNode.namespaceURI === NamespaceURI.svg)) {
                                    stack.pop();
                                    currentNode = stack[stack.length - 1] || root;
                                    ...
                                    plainTextTagName = PlainTextElements[currentNode.tagName]
                                        ? currentNode.tagName
                                        : null;
                                    readState = !!plainTextTagName
                                        ? MarkupReadStateEnum.plainTextContent
                                        : MarkupReadStateEnum.startOrEndTag;
                                    if (UnnestableElements[currentNode.tagName]) {
