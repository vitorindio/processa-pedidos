...
class Node extends EventTarget {
    ...
    constructor() {
        super();
        this.ELEMENT_NODE = NodeTypeEnum.elementNode;
        this.ATTRIBUTE_NODE = NodeTypeEnum.attributeNode;
        this.TEXT_NODE = NodeTypeEnum.textNode;
        this.CDATA_SECTION_NODE = NodeTypeEnum.cdataSectionNode;
        this.COMMENT_NODE = NodeTypeEnum.commentNode;
        this.DOCUMENT_NODE = NodeTypeEnum.documentNode;
        this.DOCUMENT_TYPE_NODE = NodeTypeEnum.documentTypeNode;
        this.DOCUMENT_FRAGMENT_NODE = NodeTypeEnum.documentFragmentNode;
        this.PROCESSING_INSTRUCTION_NODE = NodeTypeEnum.processingInstructionNode;
        this.DOCUMENT_POSITION_CONTAINED_BY = NodeDocumentPositionEnum.containedBy;
        this.DOCUMENT_POSITION_CONTAINS = NodeDocumentPositionEnum.contains;
        this.DOCUMENT_POSITION_DISCONNECTED = NodeDocumentPositionEnum.disconnect;
        this.DOCUMENT_POSITION_FOLLOWING = NodeDocumentPositionEnum.following;
        this.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC = NodeDocumentPositionEnum.implementationSpecific;
        this.DOCUMENT_POSITION_PRECEDING = NodeDocumentPositionEnum.preceding;
