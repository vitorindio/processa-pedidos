...
class Element extends Node_js_1.default {
    constructor() {
        ...
        this.scrollTop = 0;
        this.scrollLeft = 0;
        this.children = new HTMLCollection_js_1.default();
     ...
     */
    get attributes() {
        return Object.assign(new NamedNodeMap_js_1.default(this), Object.values(this._attributes), this._attributes);
    }
    /**
     * First element child.
     *
    ...
    cloneNode(deep = false) {
        ...
        for (const key of Object.keys(this._attributes)) {
            const attr = Object.assign(new Attr_js_1.default(), this._attributes[key]);
    ...
    insertAdjacentHTML(position, text) {
        for (const node of XMLParser_js_1.default.parse(this.ownerDocument, text).childNodes.slice()) {
    ...
    removeAttributeNode(attribute) {
        ...
        if (removedAttribute !== attribute) {
            throw new DOMException_js_1.default(`Failed to execute 'removeAttributeNode' on 'Element': The node provided is owned by another element.`);
        }
